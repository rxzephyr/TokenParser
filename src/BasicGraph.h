...
template<class VertexType>
void Vertex<VertexType>::setIndex(long long inIndex)
{
	index=inIndex;
}
template<class VertexType>
void Vertex<VertexType>::setData(VertexType inData)
{
	data=inData;
}
...
public:
	...
	Sequence<EdgeType> &getConstituent();
private:
...
template<class EdgeType>
Sequence<EdgeType> &Edge<EdgeType>::getConstituent()
{
	return constituent;
}
...
public:
	...
	ErrorCode_List addEdgeSymmetrical(const long long int From,const long long int To,const EdgeType &inEdgeData);
...
template<class VertexType,class EdgeType>
ErrorCode_List Graph<VertexType,EdgeType>::addEdgeSymmetrical(const long long From,const long long To,const EdgeType &inEdgeData)
{
